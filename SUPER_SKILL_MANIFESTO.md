...
It is activated by any user, through any AI agent, in under ten minutes.
...
## The Three Activation Prompts

These prompts are copied from this document and pasted into any AI agent.
They require no technical knowledge to use.

### Prompt 1: Domain Activation

```
I am activating a Super Skill for my domain.
Read the SUPER_SKILL_MANIFESTO.md in this repository to understand
what a Super Skill is and what structure it requires.

I will describe my domain and context below.
Ask me the minimum number of questions needed to generate my complete Super Skill.
Do not ask more than 3 questions.
Infer everything you can from what I provide before asking.

After your questions and my answers, generate the following files:
...
My domain: [DESCRIBE YOUR DOMAIN IN ONE TO THREE SENTENCES]
What I am building or managing: [DESCRIBE YOUR PROJECTS OR GOALS]
```

### Prompt 2: Evaluation Request

```
Using the Super Skill in this repository, evaluate the following
against my existing domain knowledge in CURRENT_STATE.md and
the criteria in EVALUATION.md.
...
What it might replace or complement: [EXISTING ELEMENT OR "unsure"]
```

### Prompt 3: Learning Generation

```
Using the Super Skill in this repository, generate a complete
learning module on the following topic as it applies to my
specific domain, context, and current state.

Include:
  - Concept explanation in the context of my domain
  - How it applies specifically to my situation
  - Key decisions already made that are relevant
  - A NotebookLM-ready summary for audio overview generation

Topic: [TOPIC WITHIN YOUR DOMAIN]
Output the NotebookLM summary to: notebooks/[topic]-learning.md
```
