# CLAUDE.md
# Claude Code operating instructions for this domain
...
- Any tier upgrade or new service adoption
- Any change that affects shared services (cross-product impact)
...
- Answering questions about current state from verified data
