...
This file records every significant decision made in this domain.
When a decision is here, it is settled. The agent does not
propose reversing it without new information.

## Decision Log

### DEC-001: Drip irrigation as the only watering method
Date: 2025-04-12
Decision: All beds use drip irrigation. No overhead sprinklers, no hand watering.
...
### DEC-002: Three-year crop rotation by plant family
Date: 2025-09-01
Decision: No nightshade in a bed that hosted nightshade in the previous two years.
Same rule for brassicas, alliums, and legumes.
...
Date: 2025-10-20
Decision: Home compost first, then bagged organic compost as supplement.
No synthetic fertilizers under any circumstances.
